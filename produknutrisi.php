...
<div class="container py-4">  
    <h3 class="mb-4">Produk Nutrsi</h3>  
  
    <form method="GET" class="mb-3">  
        <input type="text" name="search" placeholder="Cari produk..." class="form-control" value="<?= htmlspecialchars($search) ?>">  
    </form>  
    ...
    <div class="produk-grid">  
        ...
        while ($row = mysqli_fetch_assoc($query)) :  
            if (in_array($row['nama_produk'], $produk_sudah_tampil)) {  
                continue;  
            }  
            $produk_sudah_tampil[] = $row['nama_produk'];  
        ?>  
